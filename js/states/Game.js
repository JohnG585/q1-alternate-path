...
g44Game.GameState = {
  ...
  create: function() {
    ...
    // originally I had created seperate elements, but along the way learned of
    // "groups"
  ...
  update: function() {
      var score = 0;
      var scoreText = this.game.add.text(500, 50, 'score:', {
        fontSize: '32px',
        fill: '#000'
      });
    ...
    this.game.physics.arcade.overlap(this.player, this.barrels, this.hitBarrel, null, this);
  ...
  hitBarrel: function(player, barrels) {
